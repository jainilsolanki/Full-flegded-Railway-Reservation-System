...
echo " <br><a href=\"http://localhost/railway-management-system-master/schedule.php?trainno=".$_GET['trainno']."\">Go Back to Schedule!!!</a><br> ";
echo " <br><a href=\"http://localhost/railway-management-system-master/show_trains.php\">Go Back to Train Menu!!!</a><br> ";
