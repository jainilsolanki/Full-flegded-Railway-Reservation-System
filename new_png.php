...
$query=" SELECT fare FROM classseats WHERE trainno='".$tno."' AND class='".$class."'  ";
...
if($temp==0)
{
 ...
 echo "<br><br><a href=\"http://localhost/railway-management-system-master/enquiry.php\">Back to Enquiry</a> <br>";
 die();
}
...
echo "<br><br><a href=\"http://localhost/railway-management-system-master/index.htm\">Go Back!!!</a> <br>";
